...
import logoFutrli from '@/images/logos/futrli.svg'
...
export default function Home({ articles }) {
  return (
    <>
      <Head>
        <title>
          Stephen McCullough - Software engineer and amateur hobbit.
        </title>
        <meta
          name="description"
          content="I’m Stephen, a software engineer."
        />
      </Head>
      <Container className="mt-9">
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-5xl">
            Software engineer, aspiring gardener and amateur hobbit.
          </h1>
          ...
          <div className="mt-6 flex gap-6">
            <SocialLink
              href="https://twitter.com/theonlyswmcc"
              aria-label="Follow on Twitter"
              icon={TwitterIcon}
            />
            <SocialLink
              href="https://instagram.com/swmcc"
              aria-label="Follow on Instagram"
              icon={InstagramIcon}
            />
            <SocialLink
              href="https://github.com/swmcc"
              aria-label="Follow on GitHub"
              icon={GitHubIcon}
            />
            <SocialLink
              href="https://www.linkedin.com/in/theonlystephen"
